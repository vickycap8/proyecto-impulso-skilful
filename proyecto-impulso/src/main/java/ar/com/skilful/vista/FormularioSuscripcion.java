...
public class FormularioSuscripcion extends JDialog {
    ...
    public FormularioSuscripcion(
        ...
        this.suscripcionServicio = new SuscripcionServicio();
    ...
    private void cargarMembresiaActiva() {
        ...
        try (
            ...
            try (ResultSet resultado =
                ...
                campoTarifa.setText(
                    "$ " + resultado
                        .getBigDecimal("tarifa_suscripcion")
    ...
    private void registrarSuscripcion() {
        ...
        try {
            ...
            suscripcion.setIdMembresia(idMembresia);
            suscripcion.setFechaInicio(fechaInicio);
            suscripcion.setPermanenciaHasta(fechaInicio.plusMonths(6));
            suscripcion.setDiaCobro(diaCobro);
            suscripcion.setEstado("ACTIVA");

            suscripcionServicio.registrar(suscripcion);
