...
public class FormularioSocio extends JDialog {
    ...
    private void crearContenido() {
        ...
        JLabel titulo = new JLabel("REGISTRAR NUEVO SOCIO");
        ...
        panelBotones.setBorder(BorderFactory.createEmptyBorder(10, 10, 15, 20));
        ...
        botonGuardar.addActionListener(e -> guardarSocio());
    ...
    private void guardarSocio() {
        ...
        try (Connection conexion = ConexionBD.conectar();
            ...
            if (mensaje != null && mensaje.toLowerCase().contains("duplicate")) {
                mensaje = "Ya existe un socio registrado con ese DNI.";
            }
